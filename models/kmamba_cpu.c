 ...
 * Config CPU : ~500K paramètres, logs CSV et corpus borné.
 *
 * Usage:
...
/* ============================================================
 * CONFIG — instance CPU (~500K params)
 * ============================================================ */
#define VOCAB_SIZE    32768
#define DIM           48
#define STATE_SIZE    96
#define N_LAYERS      2
#define SEQ_LEN       128
...
int main(int argc, char *argv[]) {
    ...
    char *owned_log_prefix = xstrdup_local(ckpt_path ? ckpt_path : "kmamba_cpu");
